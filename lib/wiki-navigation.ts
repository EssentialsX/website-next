export type WikiNavigation = Record<string, { slug?: string; href?: string; title: string }[]>;

export const wikiNavigation: Record<string, { slug?: string; href?: string; title: string }[]> = {
    "Getting Started": [
    ...
    "Modules": [
        ...
        {href: "https://wiki.mc-ess.net/wiki/Configuration_file#EssentialsProtect", title: "Protect"},
    ...
    "Reference": [
        ...
        {href: "https://github.com/EssentialsX/Essentials/releases", title: "Changelogs"}
    ],
};
