...
_We recommend you use [LuckPerms](https://luckperms.net/download) with AntiBuild to make the most of its features._
...
_You need [Vault](https://www.spigotmc.org/resources/34315/) and [LuckPerms](https://luckperms.net/download) to give players prefixes and suffixes and to detect groups._
...
For more information on how to set up EssentialsX Discord, check out [the EssentialsX Discord tutorial](/wiki/discord)!
...
For more information, check out the [Discord Link tutorial](/wiki/discord-link)!
...
_If you don't know what XMPP is, you don't need this!_
