...
import { IconChevronDown, IconChevronRight, IconChevronUp, IconSearch } from "@tabler/icons-react";
import { useState } from "react";

export default function DumpPluginsCard({title, plugins}: { title: string, plugins: DumpPlugin[] }) {
                ...
                <div>
                    {filteredPlugins.map((plugin) => (
                        <div key={plugin.name}>
                            ...
                            >
                                <ActionIcon color="red" variant="transparent" style={{marginRight: "8px"}}>
                                    {expandedPlugin === plugin.name ? <IconChevronDown size={16}/> :
