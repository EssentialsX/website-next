    ...
    <div className='md:w-72 not-dark:bg-red-100 border-red-500 p-4 border-l-4'>
      ...
      <List spacing='xs' size='sm' mt='sm'>
        <ListItem>
          ...
          We are working on proper Folia support. Do not attempt to use current
          versions of EssentialsX on Folia or forks of it - you may lose
          userdata.
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          ...
          including Cauldron, Thermos, CatServer etc. - the Bukkit API does not
          properly support mods, and using Bukkit plugins on modded Forge/Fabric
          servers will cause significant problems. For Forge servers, use{' '}
          <a
            className='underline'
          ...
          for plugin support and a complete Essentials replacement, or consider
          a mod designed for Forge such as{' '}
          <a
            className='underline'
