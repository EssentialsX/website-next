...
const authorizeUrl =
  'https://discord.com/api/oauth2/authorize?permissions=1006652432&scope=bot%20applications.commands&client_id=';
...
export default function DiscordAuthorize() {
  ...
  return (
    <Box mx='auto' style={{ maxWidth: 500 }}>
      ...
      <Text size='sm' mt={5} c='dimmed' me={6} style={{ textAlign: 'right' }}>
        {charCount} / {maxLength}
      </Text>
    </Box>
  );
